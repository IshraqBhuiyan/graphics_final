OBJECTS= symtab.o print_pcode.o matrix.o my_main.o display.o draw.o gmath.o stack.o light.o
CFLAGS= -g
LDFLAGS= -lm
CC= gcc
...
my_main.o: my_main.c misc_headers.h print_pcode.c matrix.h display.h ml6.h draw.h stack.h light.h
	gcc -c $(CFLAGS) my_main.c

display.o: display.c display.h ml6.h matrix.h
	$(CC) $(CFLAGS) -c display.c

draw.o: draw.c draw.h display.h ml6.h matrix.h gmath.h light.h
	$(CC) $(CFLAGS) -c draw.c

light.o: light.c light.h gmath.h matrix.h ml6.h draw.h display.h
	$(CC) $(CFLAGS) -c light.c
